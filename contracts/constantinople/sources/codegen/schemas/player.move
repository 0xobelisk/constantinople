module constantinople::player_schema {
	...
	public(friend) fun set(_obelisk_world: &mut World, _obelisk_entity_key: address,  value: bool) {
		let _obelisk_schema = world::get_mut_schema<Table<address,PlayerData>>(_obelisk_world, SCHEMA_ID);
	...
	public fun get(_obelisk_world: &World, _obelisk_entity_key: address): bool {
		let _obelisk_schema = world::get_schema<Table<address,PlayerData>>(_obelisk_world, SCHEMA_ID);
